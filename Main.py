    	...
    	try:
        	while True:
            	...
            	if cipher.decrypt(p1.pid).decode()==pid:
                	if cipher.decrypt(p1.docID).decode()==T or T==("Dean"):
                    	M=1
            	break
    	except EOFError:
...
class medRecord:
	...
	def insRecord(self,d):
    	...
    	self.docID=cipher.encrypt(d.encode())
	def printRec(self):
    	print("\n")
...
#Dean hash
DH="5fc4da096f5f9dbad39f3fb48072121d82c18efcafdb4604cd6a86c975928850"
c0=1
while c0!=0:
	print("Enter 0 to exit")
